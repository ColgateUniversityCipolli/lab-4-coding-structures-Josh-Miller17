...
for (i in 1:length(chosen.vector)){
  ...
  images[i] <- sourcelink # created the full link as an object using the paste function
}
```
...
cat(paste('<img src="', images[1], '" style="width: 50%; height: auto;">'))
...
cat(paste('<img src="', images[2], '" style="width: 50%; height: auto;">'))
...
cat(paste('<img src="', images[3], '" style="width: 50%; height: auto;">'))
...
cat(paste('<img src="', images[4], '" style="width: 50%; height: auto;">'))
